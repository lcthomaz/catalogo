...
$(document).ready(function() {
    ...
    function getUserId() {
        $.ajax({
            url: 'https://homologacao.sagah.com.br/sagahcm/serv_ecommerce.php?method=getUserId',
            type: 'GET',
            data: '',
            dataType: 'json',
...
/*                         firstTime(); */
    ...
    function logout() {
        $.ajax({
            url: 'https://homologacao.sagah.com.br/sagahcm/serv_ecommerce.php?method=logout',
            type: 'GET',
            data: '',
            dataType: 'json',
            success: function(data) {
    ...
    function loadMenu() {
         $.ajax({
            url: 'https://homologacao.sagah.com.br/sagahcm/serv_ecommerce.php?method=loadHome',
            type: 'GET',
            data: '',
            dataType: 'json',
            success: function(data) {
    ...
    function getSubAreas(idAreaGeral, idAreaFormacao) {
         $.ajax({
            url: 'https://homologacao.sagah.com.br/sagahcm/serv_ecommerce.php?method=getSubAreas&idAreaGeral='+idAreaGeral+'&idAreaFormacao='+idAreaFormacao,
            type: 'GET',
            data: '',
            dataType: 'json',
            success: function(data) {
    ...
    function getUas(objeto, idAreaGeral, idAreaFormacao,idSubArea,inicial,final, pagination) {
        $.ajax({
            url: 'https://homologacao.sagah.com.br/sagahcm/serv_ecommerce.php?method=getUAs&idAreaGeral='+idAreaGeral+'&idAreaFormacao='+idAreaFormacao+'&idSubArea='+idSubArea+'&inicial='+inicial+'&final='+final,
            type: 'GET',
            data: '',
            dataType: 'json',
            success: function(data) {
                ...
                if (data.erro != null) {
                    ...
                    for (i = 0; i < ult; i++) {
                        ...
                        str += "<div class='info'><h1 style='overflow: hidden;text-overflow: ellipsis; height:39px; -webkit-line-clamp: 2;display: -webkit-box;-webkit-box-orient: vertical;width: 240px;' id='ua_"+id+"'>"+uas[id]['nome']+"</h1>";
                        str += "<span style='width:240px;overflow: hidden;text-overflow: ellipsis;'>"+uas[id]['areaFormacaoStr']+"</span></div></article>";
                    }
    ...
    function addUa(idDp, idUa) {
         $.ajax({
            url: 'https://homologacao.sagah.com.br/sagahcm/serv_ecommerce.php?method=adicionarUaNaDisciplina&idDisciplina='+idDp+'&idUA='+idUa,
            type: 'GET',
            data: '',
            dataType: 'json',
            success: function(data) {
    ...
    function search(term) {
        $.ajax({
            url: 'https://homologacao.sagah.com.br/sagahcm/serv_ecommerce.php?method=pesquisa&termos='+encodeURIComponent(term),
            type: 'GET',
            data: '',
            dataType: 'json',
            success: function(data) {
                ...
                if (data.erro != null) {
                    ...
                    for (i = 0; i < disciplinas.length; i++) {
                        ...
                        if(status != 'X') {
                            ...
                            if (nUas == 0) {
                                str += '<button id="deleteDp" data-id="'+i+'">Remover Disciplina</button>';
                            }
    ...
    function newDp(dpName, dpHours) {
        $.ajax({
            url: 'https://homologacao.sagah.com.br/sagahcm/serv_ecommerce.php?method=novaDisciplina&nome='+dpName+'&horas='+dpHours,
            type: 'GET',
            data: '',
            dataType: 'json',
            success: function(data) {
    ...
    function editDp(id, dpName, dpHours) {
        $.ajax({
            url: 'https://homologacao.sagah.com.br/sagahcm/serv_ecommerce.php?method=alterarDisciplina&id='+id+'&nome='+dpName+'&horas='+dpHours,
            type: 'GET',
            data: '',
            dataType: 'json',
            success: function(data) {
    ...
    function sendDp(id) {
        $.ajax({
            url: 'https://homologacao.sagah.com.br/sagahcm/serv_ecommerce.php?method=enviarDisciplina&id='+id,
            type: 'GET',
            data: '',
            dataType: 'json',
            success: function(data) {
    ...
    function removeUa(idDp, idUa) {
        $.ajax({
            url: 'https://homologacao.sagah.com.br/sagahcm/serv_ecommerce.php?method=removerUaDaDisciplina&idDisciplina='+idDp+'&idUA='+idUa,
            type: 'GET',
            data: '',
            dataType: 'json',
            success: function(data) {
